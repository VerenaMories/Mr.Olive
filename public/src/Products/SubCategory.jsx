      ...
      <div className="container p-4">
        <div className="row p-4">
          <div className="col-md-4 photoContainer2">
            ...
            <p style={{ color: "#3db671", textAlign: "center" }}>
              SLICED RED JALAPENO
            </p>
          </div>
          <div className="col-md-4 photoContainer2">
        ...
        <div className="lightBox2  ">
          ...
          <img
              ...
              <p style={{ color: "#fff" }}>
                ...
                Consectetur deserunt nam cupiditate illum architecto hic odit,
                dolore unde assumenda earum facere, dolorum voluptatibus totam
                porro incidunt dicta et aut aliquam.
              </p>
              <p  style={{ color: "#fff" }}>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Praesentium nostrum maxime dicta facere odit non voluptatem
                nesciunt necessitatibus quam totam.
              </p>
              <div style={{display:'flex' , justifyContent:'center'}}>
              <button
