    ...
    <div className="row">
     ...
     <i class="fa-solid fa-earth-americas" style={{position:'absolute' , top:'25px'}}></i>
             ...
             <div className="container p-4">
              ...
              <Link to='/products/subCategory'> <div  className=" product"> </div> </Link> 
                   <p style={{color:'#3db671', textAlign:'center'}}>KALAMATA OLIVE</p>
                   </div>
                 <div className="col-md-4 ">
                 <Link to='/products/subCategory1'>  <div  className=" product"> </div></Link> 
                   <p style={{color:'#3db671', textAlign:'center'}}>AZIZI OLIVE</p>
                   </div>
                   <div className="col-md-4 ">
                 <Link  to='/products/subCategory2'>  <div  className=" product"> </div></Link> 
